...
<div class="box box-danger">
    <div class="box-body">
            ...
            <p>
                <?= Html::button('<i class=\\\"fa fa-plus\\\"></i> Create Kompetensi', ['class' => 'btn btn-success input-data btn-sm','value'=>Url::to(['create'])]) ?>
            </p>
                            <?= GridView::widget([
                    ...
                    [
                        ...
                        'buttons' => [
                            ...
                            'delete' => function($url,$model,$key){
                                $link = Html::a('<span class="glyphicon glyphicon-trash"></span>', ['delete', 'id' => $model->kode], [
